...
$sql = 'SELECT sp.pokemon_id, p.french_name, sp.expiration_date, CONCAT(sp.latitude,\',\',sp.longitude) AS gps, (sp.iv_attack + sp.iv_defense + sp.iv_stamina) / .45 AS IV, sp.iv_attack, sp.iv_defense, sp.iv_stamina, z.name
FROM spawn_point sp
NATURAL JOIN pokemon p
NATURAL JOIN zone z
ORDER BY expiration_date';
